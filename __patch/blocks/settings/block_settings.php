...
class block_settings extends block_base {
    ...
    function instance_allow_multiple() {
        // PATCH+ : fix format page restore.
        /*
         * this change will let all paged format tell the standard block restore_step that
         * settings blocks in course might NOT be discarded due to a possible unicity conflict 
         * with upper context generic blocks. Settings block is likely to be the only one that 
         * has as a default setup a very global location. 
         */
        global $COURSE;
